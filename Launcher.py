"""
SekaiLink Launcher for bundled app.
...
components.extend([
    ...
    Component("SekaiLink Website", func=lambda: webbrowser.open("https://sekailink.xyz/"),
              description="Open sekailink.xyz in your browser."),
    Component("SekaiLink Discord", icon="discord", func=lambda: webbrowser.open("https://discord.gg/jTaefxAEDW"),
              description="Join the Discord server to play public multiworlds, report issues, or just chat!"),
    Component("Browse Files", func=browse_files,
              description="Open the SekaiLink installation folder in your file browser."),
])
...
def create_shortcut(button: Any, component: Component) -> None:
    ...
    make_shortcut(script, name=f"SekaiLink {component.display_name}", icon=local_path("data", "icon.ico"),
