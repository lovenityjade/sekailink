...
def local_path(*path: str) -> str:
    """
    Returns path to a file in the local SekaiLink installation or source.
...
def home_path(*path: str) -> str:
    """Returns path to a file in the user home's SekaiLink directory."""
...
def cache_path(*path: str) -> str:
    """Returns path to a file in the user's SekaiLink cache directory."""
