...
games to interact with one another in a single multiplayer environment. SekaiLink supports multi-game multiworlds.
Here is a list of our [Supported Games](/games).

## Can I generate a single-player game with SekaiLink?

Yes. All of our supported games can be generated as single-player experiences both on the website and by installing 
the SekaiLink generator software. The fastest way to do this is on the website. Find the Supported Game you wish to
...
the [SekaiLink Discord](https://discord.gg/jTaefxAEDW). There are always people ready to answer
...
by the communities surrounding them. A list of SekaiLink jargon and terms commonly used by the community can be
found in the [Glossary](/glossary/en).

## Does everyone need to be connected at the same time?

There are two different play-styles that are common for SekaiLink Multiworld sessions. These sessions can either
...
If a player must leave early, they can use SekaiLink's release system. When a player releases their game, all items
...
## I want to develop a game implementation for SekaiLink. How do I do that?

The best way to get started is to take a look at our code on GitHub:  
[SekaiLink GitHub Page](https://github.com/SekaiLink/SekaiLink).

There, you will find examples of games in the `worlds` folder:  
[/worlds Folder in SekaiLink Code](https://github.com/SekaiLink/SekaiLink/tree/main/worlds).

You may also find developer documentation in the `docs` folder:  
[/docs Folder in SekaiLink Code](https://github.com/SekaiLink/SekaiLink/tree/main/docs).
