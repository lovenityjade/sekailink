...
contextBridge.exposeInMainWorld("sekailink", {
  ...
  listCaptureSources: () => ipcRenderer.invoke("app:listCaptureSources"),
  captureSource: (sourceId) => ipcRenderer.invoke("app:captureSource", sourceId),
  ...
  hostConsoleOpen: (lobbyId) => ipcRenderer.invoke("hostConsole:open", lobbyId),
  ...
  validateRomForModule: (moduleId) => ipcRenderer.invoke("runtime:validateRomForModule", moduleId),
  ...
  listPcPackages: (options) => ipcRenderer.invoke("pcPackages:list", options),
  installPcPackage: (packageId) => ipcRenderer.invoke("pcPackages:install", packageId),
  uninstallPcPackage: (packageId) => ipcRenderer.invoke("pcPackages:uninstall", packageId),
