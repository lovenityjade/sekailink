...
export const SEKAILINK_GAME_CATALOG: SekaiLinkGameCatalogEntry[] = [
  ...
  { key: 'majoras_mask', displayName: "Majora's Mask", asset: gameAsset('majoramask.jpg'), available: true, seedEntry: { game_key: '2_ship_2_harkinian', display_name: "Majora's Mask - 2Ship2Harkinian", description: 'Native 2Ship2Harkinian Archipelago integration.', boxart: gameAsset('majoramask.jpg') } },
  ...
  { key: 'ocarina_of_time', displayName: 'Ocarina of Time', asset: gameAsset('oot.webm'), available: true, seedEntry: { game_key: 'ship_of_harkinian', display_name: 'Ocarina of Time - Ship of Harkinian', description: 'Native Ship of Harkinian Archipelago integration.', boxart: gameAsset('oot.webm') } },
  ...
  { key: 'super_mario_64', displayName: 'Super Mario 64', asset: gameAsset('sm64.png'), available: true, seedEntry: { game_key: 'super_mario_64', display_name: 'Super Mario 64', description: 'Native SM64EX Archipelago integration.', boxart: gameAsset('sm64.png') } },
