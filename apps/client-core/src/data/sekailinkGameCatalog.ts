...
const gameAsset = (fileName: string) => `/assets/img/games/${fileName}`;
...
export const SEKAILINK_GAME_CATALOG: SekaiLinkGameCatalogEntry[] = [
  ...
  { key: 'a_link_between_worlds', displayName: 'A Link Between Worlds', asset: gameAsset('albw.jpg'), available: false },
  ...
  { key: 'links_awakening_dx', displayName: "Link's Awakening DX", asset: gameAsset('ladx.jpg'), available: false, forceUnavailable: true },
  ...
  { key: 'oracle_of_ages', displayName: 'Oracle of Ages', asset: gameAsset('oraclesages.jpg'), available: false, forceUnavailable: true },
  { key: 'oracle_of_seasons', displayName: 'Oracle of Seasons', asset: gameAsset('oracleseasons.jpg'), available: false, forceUnavailable: true },
  ...
  { key: 'pokemon_emerald', displayName: 'Pokemon Emerald', asset: gameAsset('pkmnemerald.jpg'), available: false, forceUnavailable: true },
  { key: 'pokemon_firered', displayName: 'Pokemon FireRed', asset: gameAsset('pkmnfirered.jpg'), available: false, forceUnavailable: true },
  { key: 'pokemon_red_blue', displayName: 'Pokemon Red and Blue', asset: gameAsset('pkmnredblue.jpg'), available: false, forceUnavailable: true },
  { key: 'secret_of_evermore', displayName: 'Secret of Evermore', asset: gameAsset('secretevermore.jpg'), available: false },
  ...
  { key: 'super_mario_land_2', displayName: 'Super Mario Land 2', asset: gameAsset('sml2.jpg'), available: false, forceUnavailable: true },
  ...
  { key: 'wario_land', displayName: 'Wario Land', asset: gameAsset('warioland.jpg'), available: false, forceUnavailable: true },
