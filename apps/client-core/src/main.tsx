...
import "./ui-prototype/styles/linkedworldLibrary.css";
import "./ui-prototype/styles/lobby.css";
import "./ui-prototype/styles/prod-refresh.css";
import "./styles/redesignTheme.css";

const CRASH_REPORTING_OPT_IN_KEY = "skl_crash_reporting_opt_in";

trace("app", "renderer_start", {
...
window.addEventListener("error", (event) => {
  traceError("app", "window_error", event.error || event.message, {
...
window.addEventListener("unhandledrejection", (event) => {
  ...
  traceError("app", "window_unhandledrejection", reason);
  sendRendererLog({
