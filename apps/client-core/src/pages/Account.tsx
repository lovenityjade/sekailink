...
import { apiCurrentUser, apiFetch, apiJson } from "../services/api";
  ...
  useEffect(() => {
    ...
    apiCurrentUser()
      .then((data) => {
        ...
        setMe(normalized);
        setTermsVersion(normalized.terms_version || "v1");
        const accepted = Boolean(normalized.terms_accepted) && normalized.terms_version === (normalized.terms_version || "v1");
        setTermsStatus(accepted ? "accepted" : "pending");
        setTermsAcceptedAt(normalized.terms_accepted_at || null);
      })
      .catch(() => {
        setMe(null);
      });
        ...
        <div className="dashboard-hero-card">
          ...
          <div className="dashboard-profile">
            ...
            <div>
              ...
              <div className="account-id">User ID: {me?.discord_id || "—"}</div>
