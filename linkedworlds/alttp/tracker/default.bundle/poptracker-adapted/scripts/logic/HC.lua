...
local hc_back_hall = alttp_location.new("hc_back_hall", "HC Back Hall", nil, true)
local hc_main_hall = alttp_location.new("hc_main_hall", "HC Main Hall", nil, true)
local hc_left_wing = alttp_location.new("hc_left_wing", "HC Left Wing", nil, true)
local hc_right_wing = alttp_location.new("hc_right_wing", "HC Right Wing", nil, true)
local hc_back_wing = alttp_location.new("hc_back_wing", "HC Back Hallway", nil, true)
local hc_map_chest_room = alttp_location.new("hc_map_chest_room", "HC First Guard", nil, true)
local hc_before_boomerang_chest_room = alttp_location.new("hc_before_boomerang_chest_room", "HC Before Boomerang", nil, true)
local hc_boomerang_chest_room = alttp_location.new("hc_boomerang_chest_room", "HC Boomerang Chest", nil, true)
local hc_ball_guard_room = alttp_location.new("hc_ball_guard_room", "HC Cell Guard", nil, true)
local hc_zeldas_cell = alttp_location.new("hc_zeldas_cell", "HC Zeldas Cell", nil, true)
-- ce_stairs =alttp_location.new("", nil, nil, true)
-- ce_dropdown_entrance =alttp_location.new("", nil, nil, true)
local ce_dark_cross = alttp_location.new("ce_dark_cross", "CE ", nil, true)
local ce_rat_key_room = alttp_location.new("ce_rat_key_room", "CE ", nil, true)
local ce_secret_room = alttp_location.new("ce_secret_room", "CE ", nil, true)
local ce_dropdown_room = alttp_location.new("ce_dropdown_room", "CE ", nil, true)
