...
1. Install the latest version of SekaiLink.
...
2. Gather the YAMLs of all players into the `SekaiLink/Players` folder.
3. Run the SekaiLink Launcher and select Generate.
4. A zip file will be created in the `SekaiLink/output` folder. Upload this to [the SekaiLink website](/uploads) to host your game.
5. Inside the zip file is a `.apalbw` file. You will need this file to play the game.

## Playing a Game (Emulator)

1. The host will give you a `.apalbw` file. Drag and drop this file onto the SekaiLink Launcher. Alternatively, run the Launcher, click Open Patch, and select your `.apalbw` file.
...
1. Run the SekaiLink Launcher and select the A Link Between Worlds client.
