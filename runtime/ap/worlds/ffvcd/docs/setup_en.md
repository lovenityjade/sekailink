...
- [SekaiLink](https://github.com/SekaiLink/SekaiLink/releases). Make sure to check the box for `SNI Client`
...
1. During the installation of SekaiLink, you will have been asked to install the SNI Client. If you did not do this,
...
See the guide on setting up a basic YAML at the SekaiLink setup
...
5. Select the connector lua file included with your client
    - Look in the SekaiLink folder for `/SNI/lua/Connector.lua`.
...
### Connect to the SekaiLink Server
