...
* [SekaiLink](https://sekailink.com/tutorial/Archipelago/setup/en) 0.7.100 or newer
...
* [Universal Tracker](https://github.com/FarisTheAncient/Archipelago/releases) (ships with SekaiLink)
...
* Place your YAML file in `Players` folder in your SekaiLink installation (presumably `C:/Program Files/SekaiLink/Players`).
* Open SekaiLink Launcher and click Generate. A console window should pop up, do its stuff and close shortly.
* Click Host and locate your generated seed named `AP_#######.zip` at `output` folder in your SekaiLink installation (presumably `C:/Program Files/SekaiLink/output`).
...
* Open Mario Kart Double Dash Client from SekaiLink Launcher.
...
* The client can't connect to Dolphin.
  ...
  * Use SekaiLink 0.7.100 or newer.
