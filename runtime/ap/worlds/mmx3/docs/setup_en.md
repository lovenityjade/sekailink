...
- [SNI](https://github.com/alttpo/sni/releases). This is automatically included with your SekaiLink installation above.
- Software capable of loading and playing SNES ROM files:
   ...
   RAM corruption.
- Your Mega Man X3 US ROM file from the original cartridge or extracted from the Legacy Collection. SekaiLink can't provide these.
...
1. Download and install [SekaiLink](<https://github.com/SekaiLink/SekaiLink/releases/latest>). **The installer 
...
5. Select the connector lua file included with your client
    - Look in the SekaiLink folder for `/SNI/lua/`.
