# Mega Man X3 guía de instalación

## Software requerido

- [SekaiLink](https://github.com/SekaiLink/SekaiLink/releases).
- [SNI](https://github.com/alttpo/sni/releases). Este viene proporcionado junto a la instalación de SekaiLink.
...
SekaiLink no puede proveer ni uno de estos.
...
1. Descarga e instala [ArchipSekaiLinkelago](<https://github.com/SekaiLink/SekaiLink/releases/latest>). **El instalador se 
