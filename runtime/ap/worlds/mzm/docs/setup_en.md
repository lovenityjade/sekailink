...
options and export a config file from them: [Player Options Page](/games/Metroid%20Zero%20Mission/player-options)
...
file, or with a zip file containing everyone's patch files. Your patch file should have a `.apmzm`
extension.
