...
1. Pokémon Emerald usa el MultiworldGG Bizhawk Client. Si el cliente no se encuentra abierto al abrir la rom
parcheada, puedes volver a abrirlo desde el MultiworldGG Launcher.
...
7. Para conectar el cliente con el servidor, ingresa la dirección y el puerto de la sala (ej. `multiworld.gg:38281`)
