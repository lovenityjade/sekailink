...
LOCATIONS_DATA: dict[str, dict[str, Any]] = {
    ...
    "Linked Hero's Cave: Torch Chest": {
        "region_id": "d11 floor 3 torch keydrop",
        "vanilla_item": "Small Key (Linked Hero's Cave)",
        "conditional": True,
        "dungeon": 11,
        "room": 0x0529,
    ...
    "Linked Hero's Cave: Flooded Room Drop": {
        "region_id": "d11 floor 3 flooded keydrop",
        "vanilla_item": "Small Key (Linked Hero's Cave)",
        "conditional": True,
        "dungeon": 11,
        "room": 0x052a,
    ...
    "Linked Hero's Cave: Gauntlet": {
        "region_id": "d11 floor 5 gauntlet",
        "vanilla_item": "Small Key (Linked Hero's Cave)",
        "conditional": True,
        "dungeon": 11,
        "room": 0x0522,
