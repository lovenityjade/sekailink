...
- [Guide d'installation de MultiworldGG (en)](../../generic/docs/setup_en.md#installing-the-archipelago-software), requis pour installer l'apworld
- [FAQ pour Oracle of Seasons](fr_The%20Legend%20of%20Zelda%20-%20Oracle%20of%20Seasons.md#foire-aux-questions)

## Instructions d'installation

1. Téléchargez le **fichier .apworld pour Oracle of Seasons** et double-cliquez dessus afin de l'installer dans le répertoire "custom_worlds/" de votre installation MultiworldGG 
