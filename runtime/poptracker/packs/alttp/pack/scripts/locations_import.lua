...
Tracker:AddLocations("locations/lightword_entrances_outside.json")
Tracker:AddLocations("locations/lightword_entrances_inside.json")
Tracker:AddLocations("locations/darkword_entrances_outside.json")
Tracker:AddLocations("locations/darkword_entrances_inside.json")
