...
local dp_big_chest_room = alttp_location.new("dp_big_chest_room", "DP Big Chest", nil, true)
local dp_main_room = alttp_location.new("dp_main_room", "DP Main", nil, true)
local dp_torch_room = alttp_location.new("dp_torch_room", "DP Torch", nil, true)
local dp_map_chest_room = alttp_location.new("dp_map_chest_room", "DP Map Chest", nil, true)
local dp_compass_room = alttp_location.new("dp_compass_room", "DP Compass Chest", nil, true)
local dp_big_key_chest_room = alttp_location.new("dp_big_key_chest_room", "DP Big Key", nil, true)
-- dp_back_entrance = alttp_location.new("", nil, nil, true)
local dp_back_tile1_room = alttp_location.new("dp_back_tile1_room", "DP Back Tiles 1", nil, true)
local dp_back_beamos_hallway = alttp_location.new("dp_back_beamos_hallway", "DP Back Beamos ", nil, true)
local dp_back_tiles2_room = alttp_location.new("dp_back_tiles2_room", "DP Back Tiles 2", nil, true)
local dp_back_torch_room = alttp_location.new("dp_back_torch_room", "DP Back Torches", nil, true)
local dp_back_boss_room = alttp_location.new("dp_back_boss_room", "DP Boss Room", nil, true)
