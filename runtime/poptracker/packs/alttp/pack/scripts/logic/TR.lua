-- tr_main_entrance = alttp_location.new("", nil, nil, true)
-- tr_eye_bridge_entrance = alttp_location.new("", nil, nil, true)
-- tr_laser_entrance = alttp_location.new("", nil, nil, true)
-- tr_big_chest_entrance = alttp_location.new("", nil, nil, true)
local tr_square_travel_room = alttp_location.new("tr_square_travel_room", "TR Sqaure Travel", nil, true)
local tr_compass_room = alttp_location.new("tr_compass_room", "TR Compass Room", nil, true)
local tr_torch_puzzle = alttp_location.new("tr_torch_puzzle", "TR Torch Puzzle", nil, true)
local tr_map_room = alttp_location.new("tr_map_room", "TR Map Room", nil, true)
local tr_poke_1_room = alttp_location.new("tr_poke_1_room", "TR Poke 1", nil, true)
local tr_chain_chomps_room = alttp_location.new("tr_chain_chomps_room", "TR Chain Chomps", nil, true)
local tr_big_key_room_top_right = alttp_location.new("tr_big_key_room_top_right", "TR Pipes Top Right", nil, true)
local tr_big_key_room_top_left = alttp_location.new("tr_big_key_room_top_left", "TR Pipes Top Left", nil, true)
local tr_big_key_room_bottom_right = alttp_location.new("tr_big_key_room_bottom_right", "TR Pipes Bottom Right", nil, true)
local tr_big_key_room_bottom_left = alttp_location.new("tr_big_key_room_bottom_left", "TR Pipes Bottom Left", nil, true)
local tr_big_key_chest_island = alttp_location.new("tr_big_key_chest_island", "TR Pipis Center", nil, true)
local tr_shooter_after_big_key = alttp_location.new("tr_shooter_after_big_key", "TR Shooter Room", nil, true)
local tr_poke_2_room = alttp_location.new("tr_poke_2_room", "TR Poke 2", nil, true)
local tr_big_key_door_room = alttp_location.new("tr_big_key_door_room", "TR Big Key Door", nil, true)
local tr_crystalroller_room = alttp_location.new("tr_crystalroller_room", "TR Crystalroller", nil, true)
local tr_travel_maze = alttp_location.new("tr_travel_maze", "TR Dark Maze", nil, true)
local tr_side_eye_hallway = alttp_location.new("tr_side_eye_hallway", "TR Side Eye Hallway", nil, true)
local tr_switch_puzzle = alttp_location.new("tr_switch_puzzle", "TR Switch Puzzle", nil, true)
local tr_pokes_after_big_door = alttp_location.new("tr_pokes_after_big_door", "TR Pokes After Big Door", nil, true)
local tr_laser_entrance_room = alttp_location.new("tr_laser_entrance_room", "TR Laser Entrance Room", nil, true)
local tr_eye_bridge_room = alttp_location.new("tr_eye_bridge_room", "TR Eye-Bridge Room", nil, true)
local tr_boss_room = alttp_location.new("tr_boss_room", "TR Boss Room", nil, true)
