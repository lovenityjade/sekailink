...
Child_GV_Grotto_Ledge:connect_one_way_entrance("Child GV Octorok Grotto", Child_GV_Octorok_Grotto, function() return Can_use("SilverGauntlets", "child") end)
Child_GV_Grotto_Ledge:connect_one_way_entrance("Child GV Crate Ledge", Child_GV_Crate_Ledge, function() return Can_use("Longshot", "child") end)
