...
Child_Ganons_Castle_Lobby:connect_one_way_entrance("Child Ganons Castle Tower", Child_Ganons_Castle_Tower, function() 
    return All(
        ...
        CanReach("Adult_Ganons_Castle_Fire_Trial_Ending") > 5,
        CanReach("Adult_Ganons_Castle_Light_Trial_Ending") > 5,
        CanReach("Adult_Ganons_Castle_Water_Trial_Ending") > 5,
        CanReach("Adult_Ganons_Castle_Forest_Trial_Ending") > 5,
        CanReach("Adult_Ganons_Castle_Shadow_Trial_Ending") > 5,
        CanReach("Adult_Ganons_Castle_Spirit_Trial_Ending") > 5
    )
end)
