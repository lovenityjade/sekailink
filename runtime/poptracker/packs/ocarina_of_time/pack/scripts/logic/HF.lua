...
Adult_Hyrule_Fields:connect_one_way("Adult HF Ocarina of Time Item", function() return false end)
...
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Southeast Grotto", Child_HF_Southeast_Grotto, function() return Can_blast_or_smash("child") end)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Open Grotto", Child_HF_Open_Grotto)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Inside Fence Grotto", Child_HF_Inside_Fence_Grotto, function() return Can_open_bomb_grotto("child") end)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Cow Grotto", Child_HF_Cow_Grotto, function() return Can_open_bomb_grotto("child") end)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Near Market Grotto", Child_HF_Near_Market_Grotto, function() return Can_blast_or_smash("child") end)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Fairy Grotto", Child_HF_Fairy_Grotto, function() return Can_blast_or_smash("child") end)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Near Kak Grotto", Child_HF_Near_Kak_Grotto, function() return Can_open_bomb_grotto("child") end)
Child_Hyrule_Fields:connect_one_way_entrance("Child HF Tektite Grotto", Child_HF_Tektite_Grotto, function() return Can_open_bomb_grotto("child") end)
...
Adult_Hyrule_Fields:connect_one_way_entrance("Adult HF Southeast Grotto", Adult_HF_Southeast_Grotto, function() return Can_blast_or_smash("adult") end)
...
Adult_Hyrule_Fields:connect_one_way_entrance("Adult HF Near Market Grotto", Adult_HF_Near_Market_Grotto, function() return Can_blast_or_smash("adult") end)
Adult_Hyrule_Fields:connect_one_way_entrance("Adult HF Fairy Grotto", Adult_HF_Fairy_Grotto, function() return Can_blast_or_smash("adult") end)
Adult_Hyrule_Fields:connect_one_way_entrance("Adult HF Near Kak Grotto", Adult_HF_Near_Kak_Grotto, function() return Can_open_bomb_grotto("adult") end)
Adult_Hyrule_Fields:connect_one_way_entrance("Adult HF Tektite Grotto", Adult_HF_Tektite_Grotto, function() return Can_open_bomb_grotto("adult") end)

Child_HF_Southeast_Grotto:connect_one_way("Child HF Southeast Grotto Chest")
Child_HF_Southeast_Grotto:connect_one_way("Child HF Southeast Grotto Beehive 1", function() return Can_break_lower_beehive("child") end)
Child_HF_Southeast_Grotto:connect_one_way("Child HF Southeast Grotto Beehive 2", function() return Can_break_lower_beehive("child") end)
...
Adult_HF_Southeast_Grotto:connect_one_way("Adult HF Southeast Grotto Beehive 1", function() return Can_break_lower_beehive("adult") end)
Adult_HF_Southeast_Grotto:connect_one_way("Adult HF Southeast Grotto Beehive 2", function() return Can_break_lower_beehive("adult") end)
...
Child_HF_Open_Grotto:connect_one_way("Child HF Open Grotto Beehive 1", function() return Can_break_lower_beehive("child") end)
Child_HF_Open_Grotto:connect_one_way("Child HF Open Grotto Beehive 2", function() return Can_break_lower_beehive("child") end)
...
Adult_HF_Open_Grotto:connect_one_way("Adult HF Open Grotto Beehive 1", function() return Can_break_lower_beehive("adult") end)
Adult_HF_Open_Grotto:connect_one_way("Adult HF Open Grotto Beehive 2", function() return Can_break_lower_beehive("adult") end)
...
Child_HF_Inside_Fence_Grotto:connect_one_way("Child HF Deku Scrub Grotto", function() return Can_stun_deku("child") end)
Child_HF_Inside_Fence_Grotto:connect_one_way("Child HF Inside Fence Grotto Beehive", function() return Can_break_lower_beehive("child") end)

Adult_HF_Inside_Fence_Grotto:connect_one_way("Adult HF Deku Scrub Grotto", function() return Can_stun_deku("adult") end)
Adult_HF_Inside_Fence_Grotto:connect_one_way("Adult HF Inside Fence Grotto Beehive", function() return Can_break_lower_beehive("adult") end)
...
Child_HF_Cow_Grotto:connect_one_way("Child HF Cow Grotto Pot 1", function() return Has_fire_source("child") end)
Child_HF_Cow_Grotto:connect_one_way("Child HF Cow Grotto Pot 2", function() return Has_fire_source("child") end)
Child_HF_Cow_Grotto:connect_one_way("Child HF Cow Grotto Gossip Stone", function() return Has_fire_source("child") end)
...
Adult_HF_Cow_Grotto:connect_one_way("Adult HF Cow Grotto Pot 1", function() return Has_fire_source("adult") end)
Adult_HF_Cow_Grotto:connect_one_way("Adult HF Cow Grotto Pot 2", function() return Has_fire_source("adult") end)
Adult_HF_Cow_Grotto:connect_one_way("Adult HF Cow Grotto Gossip Stone", function() return Has_fire_source("adult") end)
...
Child_HF_Near_Market_Grotto:connect_one_way("Child HF Near Market Grotto Beehive 1", function() return Can_break_lower_beehive("child") end)
Child_HF_Near_Market_Grotto:connect_one_way("Child HF Near Market Grotto Beehive 2", function() return Can_break_lower_beehive("child") end)
...
Adult_HF_Near_Market_Grotto:connect_one_way("Adult HF Near Market Grotto Beehive 1", function() return Can_break_lower_beehive("adult") end)
Adult_HF_Near_Market_Grotto:connect_one_way("Adult HF Near Market Grotto Beehive 2", function() return Can_break_lower_beehive("adult") end)
