...
Child_Lon_Lon_Ranch:connect_one_way("Child LLR Child Crate", function() return Can_break_crate("child") end)
Child_Lon_Lon_Ranch:connect_one_way("Child LLR GS Tree", function() return Can_bonk("child") end)
Child_Lon_Lon_Ranch:connect_one_way("Child LLR GS Rain Shed", function() return true end)
...
Adult_Lon_Lon_Ranch:connect_one_way("Adult LLR GS Tree", function() return false end)
Adult_Lon_Lon_Ranch:connect_one_way("Adult LLR GS Rain Shed", function() return false end)
