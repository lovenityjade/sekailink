...
EVENT_MAPPING = {
    ...
    [0x4a4] = { "@Lost Continent/Tree Palace/Grand Palace Boss - Mech Rider III", true },
    [0x422] = { "@Mana Fortress/Mana Fortress Boss 1 - Buffy", true },
    [0x425] = { "@Mana Fortress/Mana Fortress Boss 2 - Dread Slime", true },
    [0x22e] = { "@Gaia's Navel/Earth Palace Mana Seed - Fire Gigas", true },
    [0x589] = { "@Kakkara Desert/Fire Palace/Fire Palace Reward - Minotaur", true },
    [0x584] = { "@Kakkara Desert/Moon Palace/Moon Palace Seed", true },
    [0x2b2] = { "@Kakkara Desert/Kakkara/Kakkara NPC", true, 2 },
    [0x587] = { "@Vandole Empire/Gold City/Gold Tower/Gold Tower Reward - Gorgon Bull", true },
    [0x688] = { "@Elinee's Castle/Elinee's Castle Reward (Chests) - Spikey Tiger", false },
    ...
    [0x677] = { "@Vandole Empire/Gold City/Gold Tower/Gold Tower Chest 2 - Blue Spike", true },
    ...
    [0x66d] = { "@Ice Country/Ice Castle/Ice Castle Boss 2 - Frost Gigas", true },
    [0x586] = { "@Lofty Mountains/Palace of Darkness/Palace of Darkness Reward - Lime Slime", true },
    [0x5f5] = { "@Pure Land/Pure Land Boss 5 - Thunder Gigas", true },
    [0x5f3] = { "@Pure Land/Pure Land Boss 4 - Red Dragon", true },
    [0x5f7] = { "@Pure Land/Pure Land Boss 6 - Blue Dragon", true },
    [0x5f8] = { "@Pure Land/Pure Land Mana Tree", true },
    [0x4e4] = { "@Upper Land/Matango/Flammie - Great Viper", true },
    [0x4e5] = { "@Lofty Mountains/Joch's Cave/Doppelgangers", true },
    [0x59b] = { "@Lost Continent/Undersea Palace/Undersea Palace Boss - Hydra", true },
    [0x4ca] = { "@Lost Continent/Undersea Palace/Undergound City Boss - Kettle Kin", true },
    [0x68e] = { "@Lofty Mountains/Palace of Darkness/Palace of Darkness Walkway Chest", true },
    [0x132] = { "@Water Palace/Water Palace Mana Seed - Jabberwocky", true },
    [0x4e2] = { "@Upper Land/Sprite Village/Wind Palace Reward - Spring Beak", true },
    [0x689] = { "@Elinee's Castle/Elinee's Castle Reward (Chests) - Spikey Tiger", false },
    ...
    [0x581] = { "@Water Palace/Undine - Biting Lizard", true },
    [0x38c] = { "@Ice Country/Tropical Town/Tropical Town Boss - Boreal Face/Salamando", true },
    [0x4b6] = { "@Lost Continent/Tree Palace/Tree Palace Reward (Mana Seed) - Snap Dragon", true },
    ...
    [0x1b9] = { "@Gaia's Navel/Dwarf Village Boss - Tropicallo", true },
    [0x188] = { "@Pandora/Pandora Castle Girl", true },
    [0x0aa] = { "@Lighthouse/Lighthouse NPC", true },
    [0x36a] = { "@Gaia's Navel/Underground Ship Boss - Kilroy", true },
    [0x112] = { "@Potos/Potos Boss - Mantis Ant", true },
    [0x5f1] = { "@Pure Land/Pure Land Boss 3 - Axe Beak", true },
    [0x5ef] = { "@Pure Land/Pure Land Boss 2 - Snow Dragon", true },
    [0x5ed] = { "@Pure Land/Pure Land Boss 1 - Dragon Worm", true },
    [0x553] = { "@Vandole Empire/North Town/North Town Ruins/North Town Ruins Boss 1 - Doom's Wall", true },
    [0x559] = { "@Vandole Empire/North Town/North Town Ruins/North Town Ruins Boss 2 - Vampire", true },
    [0x52f] = { "@Vandole Empire/North Town/North Town Castle/Outside Boss - Mech Rider II", true },
    [0x4b4] = { "@Lost Continent/Tree Palace/Tree Palace Boss 3 - Aegagropilon", true },
    [0x4a2] = { "@Lost Continent/Tree Palace/Tree Palace Boss 2 (after seed) - Hexas", true },
    [0x16e] = { "@Pandora/Pandora Ruins Boss - Wall Face", true },
    [0x527] = { "@Vandole Empire/North Town/North Town Castle/Inside Boss - Metal Mantis", true },
    [0x2d1] = { "@Tasnica/Tasnica Miniboss", true },
    [0x66a] = { "@Ice Country/Ice Castle/Ice Castle Boss 1 - Biting Lizard (x3)", true },
...
for k, _ in pairs(EVENT_MAPPING) do
    if k > MAX_EVENT_NR then
        MAX_EVENT_NR = k
    end
    if k < MIN_EVENT_NR then
        MIN_EVENT_NR = k
    end
end
EVENT_POINTER_TABLE_WATCH_START_OFFSET = MIN_EVENT_NR * 3
EVENT_POINTER_TABLE_WATCH_SIZE = (MAX_EVENT_NR - MIN_EVENT_NR + 1) * 3
