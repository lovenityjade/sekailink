CustomItemCharacter = class()

function CustomItemCharacter:init()
end

function CustomItemCharacter:createItem(name)
...
function CustomItemCharacter:onLeftClick()
end

--  Called when your item is right-clicked
function CustomItemCharacter:onRightClick()
end
...
function CustomItemCharacter:canProvideCode(code)
    return false
end
...
function CustomItemCharacter:load(data)
    return true
end
...
function CustomItemCharacter:propertyChanged(key, value)
end