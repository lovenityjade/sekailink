CustomItemElement = class()

function CustomItemElement:init()
end

function CustomItemElement:createItem(name)
...
function CustomItemElement:onLeftClick()
end

--  Called when your item is right-clicked
function CustomItemElement:onRightClick()
end
...
function CustomItemElement:canProvideCode(code)
    return false
end
...
function CustomItemElement:load(data)
    return true
end
...
function CustomItemElement:propertyChanged(key, value)
end