...
function CustomItemOrb:init()
end

function CustomItemOrb:createItem(name)
...
function CustomItemOrb:onLeftClick()
end

--  Called when your item is right-clicked
function CustomItemOrb:onRightClick()
end
...
function CustomItemOrb:canProvideCode(code)
    return false
end
...
function CustomItemOrb:load(data)
    return true
end
...
function CustomItemOrb:propertyChanged(key, value)
end