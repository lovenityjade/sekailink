CustomItemProgressiveToggle = class()

function CustomItemProgressiveToggle:init()
end

function CustomItemProgressiveToggle:createItem(name)
...
function CustomItemProgressiveToggle:onLeftClick()
end

--  Called when your item is right-clicked
function CustomItemProgressiveToggle:onRightClick()
end
...
function CustomItemProgressiveToggle:canProvideCode(code)
    return false
end
...
function CustomItemProgressiveToggle:load(data)
    return true
end
...
function CustomItemProgressiveToggle:setProperty(key, value)
    return self.ItemInstance:Set(key, value)
end

--  Call to read a transaction-backed property. DO NOT OVERRIDE
function CustomItemProgressiveToggle:getProperty(key)
...
function CustomItemProgressiveToggle:propertyChanged(key, value)
end