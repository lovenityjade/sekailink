CustomItemProgressiveToggle2 = class()

function CustomItemProgressiveToggle2:init()
end

function CustomItemProgressiveToggle2:createItem(name)
...
function CustomItemProgressiveToggle2:onLeftClick()
end

--  Called when your item is right-clicked
function CustomItemProgressiveToggle2:onRightClick()
end
...
function CustomItemProgressiveToggle2:canProvideCode(code)
    return false
end
...
function CustomItemProgressiveToggle2:load(data)
    return true
end
...
function CustomItemProgressiveToggle2:setProperty(key, value)
    return self.ItemInstance:Set(key, value)
end

--  Call to read a transaction-backed property. DO NOT OVERRIDE
function CustomItemProgressiveToggle2:getProperty(key)
...
function CustomItemProgressiveToggle2:propertyChanged(key, value)
end