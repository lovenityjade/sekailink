...
return [
    ...
    'download_url' => getenv('SEKAILINK_DOWNLOAD_URL') ?: 'https://sekailink.com/downloads/client/bootstrapper/latest/SekaiLink-bootstrapper-windows.zip',
    ...
    'download_label' => getenv('SEKAILINK_DOWNLOAD_LABEL') ?: 'Windows bootstrapper public test',
