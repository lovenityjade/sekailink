...
struct RuntimeBridgeState {
  ...
  std::optional<std::string> session_token_hash;
  std::optional<std::string> ticket_issued_at;
  std::optional<std::string> last_heartbeat_at;
  std::optional<std::string> last_item_delivery_at;
  std::optional<std::string> last_check_report_at;
  std::optional<std::string> last_delivery_ack_at;
  std::optional<std::string> last_disconnect_reason;
  std::optional<std::int64_t> last_delivery_ack_id;
  std::vector<std::int64_t> acknowledged_delivery_ids;
...
struct RoomStateSnapshot {
  ...
  nlohmann::json linkedworld_surface = nlohmann::json::object();
  nlohmann::json seed_contract = nlohmann::json::object();
  ...
  std::optional<RuntimeBridgeState> runtime_state;
