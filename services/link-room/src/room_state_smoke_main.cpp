...
int main() {
  try {
    ...
    snapshot.runtime_state = RuntimeBridgeState{
        .runtime_kind = "runtime",
        .runtime_session_name = "room-001",
        .driver_instance_id = "sklmi-driver-1",
        .linkedworld_id = "alttp",
        .core_profile = "snes_v1",
        .session_token_hash = "deadbeefcafebabe",
        .ticket_issued_at = "2026-03-26T12:00:00Z",
        .last_delivery_ack_at = "2026-03-26T12:01:00Z",
        .last_delivery_ack_id = 0,
        .acknowledged_delivery_ids = {0},
        .connected = true,
    };
    ...
    require(payload["runtime_state"]["session_token_hash"] == "deadbeefcafebabe", "runtime_session_token_hash");
