...
class AIWriter:
    def __init__(self, config: ServiceConfig) -> None:
        self.config = config
        self.memory: SemanticMemory | None = None
...
"""
    ...
    def stats(self) -> dict:
        return {
            ...
            "memory_chunks": self.memory.count() if self.memory is not None else 0,
