...
typedef enum {
    ...
    TEXT_MEDIROGON_CANT_AFFORD = 0x00C8,
    TEXT_BLUE_RUPEE = 0x00CC,
    TEXT_SARIAS_SONG_TALK_NAVI_INSTEAD = 0x00E1,
    TEXT_SARIAS_SONG_TALK_SARIA_AGAIN = 0x00E3,
    ...
    TEXT_SCRUB_NO_WAY = 0x10A4,
    TEXT_SCRUB_CANT_AFFORD = 0x10A5,
    TEXT_SCRUB_CAPACITY_FULL = 0x10A6,
    TEXT_SCRUB_PURCHACE_SUCCESS = 0x10A7,
    TEXT_SARIA_SFM = 0x10AD,
    TEXT_SCRUB_STICK_UPGRADE = 0x10DC,
    TEXT_SCRUB_NUT_UPGRADE = 0x10DD,
    TEXT_SCRUB_CANT_GET = 0x10DE,
    ...
    TEXT_GRANNYS_SHOP_CHANGE_YOUR_MIND = 0x500D,
    TEXT_GRANNYS_SHOP_CANT_AFFORD = 0x500E,
    ...
    TEXT_CARPET_SALESMAN_DECLINE = 0x6074,
    TEXT_CARPET_SALESMAN_CANT_AFFORD = 0x6075,
