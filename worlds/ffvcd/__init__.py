...
class FFVCDWebWorld(WebWorld):
    setup_en = Tutorial(
        ...
        "A guide to playing Final Fantasy V Career Day with MultiworldGG.",
        "English",
        "setup_en.md",
        "setup/en",
        ["cleartonic"]
...
class FFVCDWorld(World):
    """
    Final Fantasy V is the fifth main installment of the Final Fantasy series. The game begins as a wanderer named Bartz investigates a fallen meteor. There, he encounters several characters, one of whom reveals the danger facing the four Crystals that control the world's elements. Career Day is a popular Open World randomizer for FFV.
    """
