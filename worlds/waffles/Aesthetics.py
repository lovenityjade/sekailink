...
def generate_shuffled_sfx(rom, world: "WaffleWorld"):
...
def generate_shuffled_level_music(world: "WaffleWorld"):
...
def generate_shuffled_ow_music(world: "WaffleWorld"):
...
def generate_shuffled_ow_palettes(rom, world: "WaffleWorld"):
...
def generate_curated_level_palette_data(rom, world: "WaffleWorld"):
...
def generate_curated_map_palette_data(rom, world: "WaffleWorld"):
